...
export const LintyAxios = createCustomAxiosInstance({
  baseURL: SERVER_URL,
  headers: {
...
LintyAxios.interceptors.request.use((response)=>response,requestInterceptor);
LintyAxios.interceptors.response.use((response)=>response, responseErrorInterceptor);

export default LintyAxios;
